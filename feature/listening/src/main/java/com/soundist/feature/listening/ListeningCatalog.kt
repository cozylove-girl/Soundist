...
object RadioCatalog {
    ...
    private fun channel(
        ...
        // 首发只显示「基础 APK 内置 + 可下载离线包」曲目；未分包的 206 首不进入可见目录（不生成假地址）。
...
/** 全量内置曲目（assets/radio/ 真实文件，共 294 首）的 trackId → 扩展名。
 *  由 RADIO_AUDIO_MANIFEST.tsv + assets/radio 实际文件自动生成，保留真实扩展名（ogg/mp3/flac/wav/oga）。
 *  所有曲目已全量打包进基础 APK，不再使用离线包。 */
private val baseApkAssets = mapOf(
    "albinoni-oboe-one" to "ogg",
    "albinoni-oboe-three" to "ogg",
    "albinoni-oboe-two" to "ogg",
    "ambient-brenticus" to "ogg",
    "ambient-dance-zeropage" to "ogg",
    "ambient-guitar-dust" to "mp3",
    "ambient-india-zeropage" to "ogg",
    "ambient-pad-i" to "mp3",
    "ambient-pad-ii" to "mp3",
    "ambient-pad-iv" to "mp3",
    "ambient-pad-ix" to "mp3",
    "ambient-pad-v" to "mp3",
    "ambient-pad-vi" to "mp3",
    "ambient-pad-vii" to "mp3",
    "ambient-pad-viii" to "mp3",
    "ambient-pad-x" to "mp3",
    "ambient-relax-background-one" to "ogg",
    "ambient-sunset-walk" to "ogg",
    "ambient-voyager" to "ogg",
    "ambient-zero-point" to "ogg",
    "andersen-etude" to "oga",
    "atlantean-twilight" to "mp3",
    "bach-air" to "ogg",
    "bach-bwv147-chorale" to "ogg",
    "bach-chaconne" to "ogg",
    "bach-goldberg-aria" to "ogg",
    "bach-goldberg-aria-cc0" to "ogg",
    "bach-goldberg-cc0-01" to "ogg",
    "bach-goldberg-cc0-02" to "ogg",
    "bach-goldberg-cc0-03" to "ogg",
    "bach-goldberg-cc0-04" to "ogg",
    "bach-goldberg-cc0-05" to "ogg",
    "bach-goldberg-cc0-06" to "ogg",
    "bach-goldberg-cc0-07" to "ogg",
    "bach-goldberg-cc0-08" to "ogg",
    "bach-goldberg-cc0-09" to "ogg",
    "bach-goldberg-cc0-10" to "ogg",
    "bach-goldberg-cc0-11" to "ogg",
    "bach-goldberg-cc0-12" to "ogg",
    "bach-goldberg-cc0-13" to "ogg",
    "bach-goldberg-cc0-14" to "ogg",
    "bach-goldberg-cc0-15" to "ogg",
    "bach-goldberg-cc0-16" to "ogg",
    "bach-goldberg-cc0-27" to "ogg",
    "bach-goldberg-cc0-28" to "ogg",
    "bach-goldberg-cc0-29" to "ogg",
    "bach-goldberg-cc0-30" to "ogg",
    "bach-goldberg-var8" to "ogg",
    "bach-partita-preludio" to "ogg",
    "bach-passacaglia-bwv582" to "ogg",
    "bach-sonata-adagio" to "ogg",
    "bach-wtc-prelude" to "ogg",
    "background-music-one" to "ogg",
    "beats-disco-lounge" to "mp3",
    "beats-electro-cabello" to "mp3",
    "beats-faster-does-it" to "mp3",
    "beats-funkorama" to "mp3",
    "beats-groove-grove" to "mp3",
    "beethoven-32-variations" to "ogg",
    "beethoven-cello-sonata-three-two" to "ogg",
    "beethoven-concerto-largo" to "ogg",
    "beethoven-diabelli-01-02" to "ogg",
    "beethoven-diabelli-03-04" to "ogg",
    "beethoven-diabelli-05-07" to "ogg",
    "beethoven-diabelli-08-10" to "ogg",
    "beethoven-diabelli-11-13" to "ogg",
    "beethoven-diabelli-14" to "ogg",
    "beethoven-diabelli-15-17" to "ogg",
    "beethoven-diabelli-18-19" to "ogg",
    "beethoven-diabelli-20-23" to "ogg",
    "beethoven-diabelli-24" to "ogg",
    "beethoven-diabelli-25-29" to "ogg",
    "beethoven-diabelli-30" to "ogg",
    "beethoven-diabelli-31" to "ogg",
    "beethoven-diabelli-32" to "ogg",
    "beethoven-diabelli-33" to "ogg",
    "beethoven-diabelli-theme" to "ogg",
    "beethoven-hammerklavier-adagio" to "ogg",
    "beethoven-minuet" to "ogg",
    "beethoven-nine-four" to "ogg",
    "beethoven-nine-one" to "flac",
    "beethoven-nine-three" to "flac",
    "beethoven-nine-two" to "flac",
    "beethoven-quartet-six-adagio" to "flac",
    "beethoven-quartet-six-malinconia" to "flac",
    "beethoven-sonata-28-one" to "ogg",
    "beethoven-sonata-28-three" to "ogg",
    "borodin-steppes" to "ogg",
    "brahms-clarinet-quintet-adagio" to "ogg",
    "brahms-op116-four" to "ogg",
    "brahms-op117-two" to "ogg",
    "brahms-op118-two" to "ogg",
    "calm-bgm" to "ogg",
    "calm-fireplace-guitar" to "mp3",
    "cello-bach-allemande" to "ogg",
    "cello-bach-allemande-john-michel" to "ogg",
    "cello-bach-casals-prelude" to "ogg",
    "cello-bach-cc0-prelude" to "ogg",
    "cello-bach-gigue" to "ogg",
    "cello-bach-sarabande" to "ogg",
    "cello-debussy-beau-soir" to "ogg",
    "cello-faure-elegie" to "ogg",
    "cello-saint-saens-swan" to "ogg",
    "cello-vivaldi-allegro-one" to "ogg",
    "cello-vivaldi-allegro-three" to "ogg",
    "cello-vivaldi-largo" to "ogg",
    "chill-beat" to "ogg",
    "chill-lofi" to "ogg",
    "chilled-lofi" to "mp3",
    "chopin-allegro-concert" to "mp3",
    "chopin-ballade-three" to "mp3",
    "chopin-ballade-two" to "mp3",
    "chopin-barcarolle" to "ogg",
    "chopin-barcarolle-cc0" to "ogg",
    "chopin-berceuse-pd" to "ogg",
    "chopin-canon-f-minor" to "mp3",
    "chopin-concerto-quartet-one" to "ogg",
    "chopin-concerto-quartet-three" to "ogg",
    "chopin-concerto-quartet-two" to "ogg",
    "chopin-etude-10-1" to "ogg",
    "chopin-fantaisie-op49" to "wav",
    "chopin-mazurka-17-4" to "ogg",
    "chopin-nocturne-55" to "ogg",
    "chopin-nocturne-62" to "ogg",
    "choral-handel-glory" to "ogg",
    "choral-handel-word" to "ogg",
    "choral-pavane" to "ogg",
    "choral-racine" to "ogg",
    "choral-resonet-laudibus" to "ogg",
    "choral-salve-regina" to "ogg",
    "choral-tollite" to "ogg",
    "choral-vivaldi-esurientes" to "ogg",
    "choral-vivaldi-gloria" to "ogg",
    "choral-vivaldi-misericordia" to "ogg",
    "corelli-christmas-one" to "ogg",
    "corelli-christmas-two" to "ogg",
    "corelli-op6-no4-one" to "ogg",
    "couperin-barricades" to "ogg",
    "debussy-arabesque-one-prati" to "ogg",
    "debussy-arabesque-two" to "ogg",
    "debussy-clair-brass" to "mp3",
    "debussy-clair-de-lune-goedhart" to "ogg",
    "debussy-doctor-gradus" to "wav",
    "debussy-sketchbook" to "ogg",
    "debussy-syrinx" to "ogg",
    "dream-culture" to "mp3",
    "dvorak-larghetto" to "ogg",
    "dvorak-new-world-largo" to "ogg",
    "electronic-piano" to "ogg",
    "emotional-piano" to "ogg",
    "end-of-hope" to "mp3",
    "erhu-erquan" to "ogg",
    "erhu-river" to "ogg",
    "exploration" to "mp3",
    "fairies-talking" to "ogg",
    "faure-berceuse-op56" to "ogg",
    "faure-elegie" to "ogg",
    "game-bgm" to "ogg",
    "gaohu-linked-buckles" to "ogg",
    "gaohu-rain-banana" to "ogg",
    "glazunov-menestrel" to "ogg",
    "grieg-piano-concerto-adagio" to "ogg",
    "guitar-anonymous-romance" to "ogg",
    "guitar-el-noi" to "ogg",
    "guitar-pachelbel-canon" to "ogg",
    "guitar-solo" to "ogg",
    "guitar-sor-op31-1" to "ogg",
    "guitar-tarrega-gran-vals" to "ogg",
    "guqin-yangguan-sandie" to "ogg",
    "guqin-zuiyu-changwan" to "ogg",
    "handel-fitzwilliam-three" to "ogg",
    "harp-meadow-thoughts" to "ogg",
    "haydn-lark-one" to "ogg",
    "haydn-lark-three" to "ogg",
    "incompetech-starry" to "mp3",
    "indieteur-revelation" to "mp3",
    "into-stars" to "ogg",
    "jazz-avant" to "mp3",
    "jazz-brunch" to "mp3",
    "jazz-dont-care-blues" to "ogg",
    "jazz-memphis-blues" to "mp3",
    "jazz-park" to "ogg",
    "jazz-samba" to "mp3",
    "jazz-simple" to "ogg",
    "joth-contemplation" to "mp3",
    "just-as-soon" to "mp3",
    "kumasi-groove" to "mp3",
    "lofi-again" to "ogg",
    "lofi-caden-currie" to "mp3",
    "lofi-de" to "ogg",
    "lofi-hiphop" to "ogg",
    "lofi-music-001" to "wav",
    "lofi-perspective" to "ogg",
    "lofi-upbeat-raspberry" to "ogg",
    "lyrics-auld-lang-syne" to "ogg",
    "lyrics-debussy-ariettes-four" to "ogg",
    "lyrics-debussy-ariettes-two" to "ogg",
    "lyrics-frankie-johnny" to "ogg",
    "lyrics-kentucky-home" to "ogg",
    "lyrics-mozart-luise" to "ogg",
    "lyrics-mozart-violet" to "ogg",
    "lyrics-old-black-joe" to "ogg",
    "lyrics-old-folks" to "ogg",
    "lyrics-perfect-day" to "ogg",
    "meditation-impromptu-one" to "mp3",
    "meditation-impromptu-three" to "mp3",
    "meditation-impromptu-two" to "mp3",
    "mendelssohn-nocturne" to "ogg",
    "mendelssohn-scottish-adagio" to "ogg",
    "mendelssohn-venetian-gondola-30-6" to "ogg",
    "modern-piano-almost-f" to "mp3",
    "modern-piano-at-rest" to "mp3",
    "modern-piano-clean-soul" to "mp3",
    "mozart-clarinet-adagio" to "ogg",
    "mozart-divertimento-113-three" to "oga",
    "mozart-divertimento-113-two" to "oga",
    "mozart-flute-harp-allegro" to "ogg",
    "mozart-flute-harp-andantino" to "ogg",
    "mozart-flute-harp-rondeau" to "ogg",
    "mozart-flute-k313" to "ogg",
    "mozart-k421-andante-musopen" to "flac",
    "mozart-k421-four" to "ogg",
    "mozart-k421-one" to "ogg",
    "mozart-k421-three" to "flac",
    "mozart-k421-two" to "flac",
    "mozart-k465-adagio-allegro" to "flac",
    "mozart-rondo-k511" to "ogg",
    "night-docks-trumpet" to "mp3",
    "not-that-east" to "ogg",
    "cc0-blue-intermission" to "ogg",
    "cc0-catchy-swing" to "ogg",
    "cc0-etirwer" to "ogg",
    "cc0-frets" to "ogg",
    "cc0-fusion-jazz" to "ogg",
    "cc0-jazzy-blues" to "ogg",
    "cc0-middle-nowhere-remix" to "ogg",
    "cc0-one-step" to "ogg",
    "cc0-serenade-guitar" to "ogg",
    "cc0-sunset-plains" to "ogg",
    "organ-bach-526-one" to "mp3",
    "organ-bach-529-one" to "mp3",
    "organ-bach-543-fugue" to "mp3",
    "organ-bach-543-prelude" to "mp3",
    "organ-buxtehude-toccata" to "ogg",
    "organ-pachelbel-chorale" to "ogg",
    "organ-pachelbel-ciacona" to "ogg",
    "organ-pachelbel-fugue-13" to "ogg",
    "organ-pachelbel-toccata-e" to "ogg",
    "organ-pachelbel-toccata-f" to "ogg",
    "pachelbel-canon-kevin-macleod" to "ogg",
    "pachelbel-canon-piano-galloway" to "ogg",
    "purcell-abdelazer-suite" to "ogg",
    "rameau-gavotte-doubles" to "flac",
    "ravel-pavane-pd" to "ogg",
    "respighi-intermezzo-serenata" to "ogg",
    "rhapsody-blue" to "ogg",
    "saint-saens-swan" to "ogg",
    "satie-gymnopedie-one-macleod" to "mp3",
    "scarlatti-k159" to "ogg",
    "scarlatti-k466" to "ogg",
    "schubert-impromptu-d935-three" to "ogg",
    "schumann-kinderszenen-one" to "ogg",
    "schumann-kinderszenen-seven" to "ogg",
    "schumann-kinderszenen-ten" to "ogg",
    "scriabin-prelude-67-1" to "ogg",
    "small-fire-guitar-loop" to "wav",
    "smetana-moldau" to "ogg",
    "solo-piano-four" to "ogg",
    "synth-hiphop" to "ogg",
    "tchaikovsky-seasons-april" to "ogg",
    "tchaikovsky-seasons-august" to "ogg",
    "tchaikovsky-seasons-december" to "ogg",
    "tchaikovsky-seasons-february" to "ogg",
    "tchaikovsky-seasons-january" to "ogg",
    "tchaikovsky-seasons-july" to "ogg",
    "tchaikovsky-seasons-june" to "ogg",
    "tchaikovsky-seasons-march" to "ogg",
    "tchaikovsky-seasons-may" to "ogg",
    "tchaikovsky-seasons-november" to "ogg",
    "tchaikovsky-seasons-october" to "ogg",
    "tchaikovsky-seasons-september" to "ogg",
    "tiny-movement" to "mp3",
    "vivaldi-double-one" to "ogg",
    "vivaldi-double-three" to "ogg",
    "vivaldi-double-two" to "ogg",
    "vivaldi-notte-four" to "ogg",
    "vivaldi-notte-one" to "ogg",
    "vivaldi-notte-three" to "ogg",
    "vivaldi-notte-two" to "ogg",
    "vivaldi-recorder-three" to "ogg",
    "vivaldi-recorder-two" to "ogg",
    "vivaldi-winter-allegro" to "ogg",
    "vivaldi-winter-largo" to "ogg",
    "weber-grand-duo-andante" to "ogg",
    "white-lotus" to "mp3",
    "yd-searching" to "ogg",
    "yoiyami-deep-blue" to "wav",
    "yoiyami-first-light" to "wav",
    "zither-strauss-woods" to "ogg",
)
